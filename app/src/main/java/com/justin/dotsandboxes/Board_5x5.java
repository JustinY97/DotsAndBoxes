...
public class Board_5x5  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        help_button.setOnClickListener(view -> {
            Intent intent = new Intent(Board_5x5.this, Help.class);
            startActivity(intent);
        });
        ...
        //Row 1
        blocks.put(squares[0], new View[]{horizontals[0], horizontals[5], verticals[0], verticals[1]});
        blocks.put(squares[1], new View[]{horizontals[1], horizontals[6], verticals[1], verticals[2]});
        blocks.put(squares[2], new View[]{horizontals[2], horizontals[7], verticals[2], verticals[3]});
        blocks.put(squares[3], new View[]{horizontals[3], horizontals[8], verticals[3], verticals[4]});
...
//        }
            ...
            if (filled_boxes == 25) {
                ...
                Intent intent = new Intent(Board_5x5.this, winnerPage.class);
